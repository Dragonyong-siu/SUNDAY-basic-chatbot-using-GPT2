...
config = GPT2Config.from_pretrained("microsoft/DialoGPT-small" , output_hidden_states=True)
model = GPT2Model(config).from_pretrained("microsoft/DialoGPT-small", config = config)
